        ...
        >
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-foreground">
            ...
            <div className="space-y-3">
              ...
              <p className="text-base leading-relaxed">
                Subject to the terms and conditions set forth in these Terms of Use, Quantum Data Leap grants You a non-exclusive, non-transferable, limited right to access, use and view the Website and the Materials. You agree not to interrupt or attempt to interrupt the operation of the Website in any manner. Unless otherwise specified, the Website is for your personal and non-commercial use. You shall not modify, copy, distribute, transmit, display, perform, reproduce, publish, license, create derivative works from, transfer, or sell any information, software, services obtained from the Website.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-base leading-relaxed font-medium">
                IN NO EVENT SHALL QUANTUM DATA LEAP OR ANY OF ITS SUBSIDIARIES OR AFFILIATES BE LIABLE TO ANY ENTITY FOR ANY DIRECT, INDIRECT, SPECIAL, CONSEQUENTIAL OR OTHER DAMAGES (INCLUDING, WITHOUT LIMITATION, ANY LOST PROFITS, BUSINESS INTERRUPTION, LOSS OF INFORMATION OR PROGRAMS OR OTHER DATA ON YOUR INFORMATION HANDLING SYSTEM) THAT ARE RELATED TO THE USE OF, OR THE INABILITY TO USE, THE CONTENT, MATERIALS, THIRD PARTY CONTENT AND FUNCTIONS OF THE WEBSITE OR ANY LINKED WEBSITE, EVEN IF QUANTUM DATA LEAP IS EXPRESSLY ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-base leading-relaxed font-medium">
                THE WEBSITE MAY CONTAIN INACCURACIES AND TYPOGRAPHICAL AND CLERICAL ERRORS. QUANTUM DATA LEAP EXPRESSLY DISCLAIMS ANY OBLIGATION(S) TO UPDATE THE WEBSITE OR ANY OF THE MATERIALS ON THE WEBSITE. QUANTUM DATA LEAP DOES NOT WARRANT THE ACCURACY OR COMPLETENESS OF THE MATERIALS OR THE RELIABILITY OF ANY ADVICE, OPINION, STATEMENT OR OTHER INFORMATION DISPLAYED OR DISTRIBUTED THROUGH THE WEBSITE. YOU ACKNOWLEDGE THAT ANY RELIANCE ON ANY SUCH OPINION, ADVICE, STATEMENT, MEMORANDUM, OR INFORMATION SHALL BE AT YOUR SOLE RISK. QUANTUM DATA LEAP RESERVES THE RIGHT, IN ITS SOLE DISCRETION, TO CORRECT ANY ERRORS OR OMISSIONS IN ANY PORTION OF THE WEBSITE. QUANTUM DATA LEAP MAY MAKE ANY OTHER CHANGES TO THE WEBSITE, THE MATERIALS AND THE PROGRAMS, SERVICES OR PRICES (IF ANY) DESCRIBED IN THE WEBSITE AT ANY TIME WITHOUT NOTICE. THE WEBSITE IS FOR INFORMATIONAL PURPOSES ONLY AND SHOULD NOT BE CONSTRUED AS TECHNICAL ADVICE OF ANY MANNER.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-base leading-relaxed">
                Quantum Data Leap does not claim ownership of the materials You provide to Quantum Data Leap (including feedback and suggestions) or post, upload, input or submit to any section of the Website (each a "Submission" and collectively "Submissions"). However, by posting, uploading, inputting, providing or submitting ("Posting") your Submissions, You are granting Quantum Data Leap, its affiliated companies and subsidiaries and necessary sub-licensees permission to use your Submission in connection with the operation of their Internet businesses (including, without limitation, all services offered by Quantum Data Leap), including, without limitation, the license rights to: copy, distribute, transmit, publicly display, publicly perform, reproduce, edit, translate and reformat your Submission; to publish your name in connection with your Submission; and the right to sublicense such rights to any other party.
              </p>
              <p className="text-base leading-relaxed">
                You hereby acknowledge and agree that no compensation shall be paid or no future commercial consideration has accrued with respect to the use of your Submission by Quantum Data Leap or any of its subsidiaries, as provided herein. Quantum Data Leap shall be under no obligation to post or use any Submission You may provide and Quantum Data Leap shall remove any Submission at any time at its own sole discretion.
              </p>
              <p className="text-base leading-relaxed">
            ...
            <div className="space-y-3">
              ...
              <p className="text-base leading-relaxed">
                As a condition of your use of the Website, You shall not use the Website for any purpose(s) that is unlawful or prohibited by the Terms of Use. You shall not use the Website in any manner that could damage, disable, overburden, or impair any Quantum Data Leap (including its subsidiaries) server, or the network(s) connected to any Quantum Data Leap (including its subsidiaries) server, or interfere with any other party's use and enjoyment of any services associated with the Website. You shall not attempt to gain unauthorized access to any section of the Website, other accounts, computer systems or networks connected to any Quantum Data Leap server or to any of the services associated with the Website, through hacking, password mining or any other means. You shall not obtain or attempt to obtain any Materials or information through any means not intentionally made available through the Website.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-base leading-relaxed">
                Quantum Data Leap reserves the rights, at its sole discretion, to change, modify, add or remove any portion of these Terms of Use in whole or in part, at any time. Changes in these Terms of Use will be effective when notice of such change is posted. Your continued use of the Website after any changes to these Terms of Use are posted will be considered acceptance of those changes. Quantum Data Leap may terminate, change, suspend or discontinue any aspect of the Website, including the availability of any feature(s) of the Website, at any time. Quantum Data Leap may also impose limits on certain features and services or restrict your access to certain sections or all of the Website without notice or liability. You hereby acknowledge and agree that Quantum Data Leap may terminate the authorization, rights and license given above at any point of time at its own sole discretion and, upon such termination, You shall immediately destroy all Materials.
              </p>
            </div>
          </div>
