    ...
    >
      ...
      >
        <h1 className="text-foreground text-3xl md:text-4xl lg:text-6xl font-semibold leading-tight">
          Welcome to Quantum Data Leap
        </h1>
        <p className="text-muted-foreground text-base md:text-base lg:text-lg font-medium leading-relaxed max-w-lg mx-auto">
          Empower your banking systems with intelligent data control, liquidity management, fraud detection, and rules
          automation.
        </p>
      </motion.div>
      ...
      <motion.button
        ...
        whileHover={{ scale: 1.05, boxShadow: "0 20px 40px rgba(120, 252, 214, 0.2)" }}
        whileTap={{ scale: 0.98 }}
        className="relative z-10 bg-secondary text-secondary-foreground hover:bg-secondary/90 px-8 py-3 rounded-full font-medium text-base shadow-lg ring-1 ring-white/10 transition-all duration-300"
      >
        Explore QDL Universe
      </motion.button>
    </section>
  )
}
